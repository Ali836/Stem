...
<p>We wanted to learn how to code and we found a website called <a href="https://www.codecademy.com/ ">Codecadamy</a> it is a website where it gos by lesson and units each unit you have the example of a website and the coe of it to the left is the lesson an the intructions to an activity.I did a series of test (10 tests) with 20 questions each test in website called <a href="http://www.pskills.org/ ">Programming Skills </a> and the result are in the table below, the average of our knowledge is 59% correct. Even if we know the basics of coding we had alot to learn. 
<img src="http://www.codepancake.com/wp-content/uploads/2015/05/Screen-Shot-2015-05-05-at-17.32.26.png" height="100%" width="100%">
